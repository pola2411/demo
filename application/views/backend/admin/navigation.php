...
<div class="left-side-menu left-side-menu-detached">
	...
	<ul class="metismenu side-nav side-nav-light">
		...
		<?php endif; ?>
		<?php if (has_permission('enrolment')) : ?>
			<li class="side-nav-item <?php if ($page_name == 'slider' || $page_name == 'slider') : ?> active <?php endif; ?>">
				<a href="javascript: void(0);" class="side-nav-link <?php if ($page_name == 'slider' || $page_name == 'slider') : ?> active <?php endif; ?>">
					<i class="dripicons-network-3"></i>
					<span> <?php echo get_phrase('Sliders'); ?> </span>
					<span class="menu-arrow"></span>
				</a>
				<ul class="side-nav-second-level" aria-expanded="false">
					<li class="<?php if ($page_name == 'slider') echo 'active'; ?>">
						<a href="<?php echo site_url('admin/slideradd'); ?>"><?php echo get_phrase('slider_add'); ?></a>
					</li>
					<li class="<?php if ($page_name == 'sliders') echo 'active'; ?>">
