                ...
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('user/enrol_student/enrol'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="server-side-select2" action="<?php echo base_url('user/get_select2_user_data'); ?>" name="user_id[]" multiple="multiple" required>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control select2-multiple" data-toggle="select2" multiple="multiple" onchange="get_price(this)" data-placeholder="Choose ..." name="course_id[]" id="multiple_course_id" required>
                                ...
                                <?php $course_list = $this->db->where('status', 'active')->where('user_id',$this->session->userdata('user_id'))->or_where('status', 'private')->get('course')->result_array();
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form id="required-form1"  action="<?php echo site_url('user/enrol_section_student/enrol'); ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form2" action="<?php echo site_url('user/enrol_lession_student/enrol'); ?>" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
   function get_price(selectElement) {
    ...
    $.ajax({
        url: '<?php echo site_url('user/get_sections'); ?>', // Adjust this to your route
        type: 'POST',
        dataType: 'json',
...
function loadSections2() {
    ...
    $.ajax({
        url: '<?php echo site_url('user/get_lession'); ?>', // Adjust this to your route
        type: 'POST',
        dataType: 'json',
        data: {course_id: course_id},
        success: function(response) {
